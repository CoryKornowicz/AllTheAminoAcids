...
class AllTheAATool(ToolInstance):
    ...
    def __init__(self, session, tool_name):
        ...
        self.display_name = "AllTheAminoAcids"
    ...
    def _build_ui(self):
        ...
        from Qt.QtWidgets import QVBoxLayout, QSpacerItem, QSizePolicy
        layout = QVBoxLayout()
        

        self.widget = AA_Widget()
    ...
    def fill_context_menu(self, menu, x, y):
        ...
        clear_action.triggered.connect(lambda *args: None)
